...
export const getPayProduct = createAsyncThunk(
    ...
    async () => {
        const response = await axios.get(`http://13.228.168.148:3000/orders_pay`);
...
export const insertPayProduct = createAsyncThunk(
    ...
    async (obj) => {
        ...
        await axios.post('http://13.228.168.148:3000/orders_pay', newOrderPay);
        return newOrderPay;
    },
);
...
export const updatePayProduct = createAsyncThunk(
    ...
    async (obj) => {
        ...
        await axios.put(
            `http://13.228.168.148:3000/orders_pay/${obj.id}`,
            newPayProduct,
        );
...
export const deletePayProductAllApi = createAsyncThunk(
    ...
    async (obj) => {
        let arrProduct = [];
        setTimeout(async () => {
            await axios.delete(`http://13.228.168.148:3000/orders_pay/${obj.id}`);
        }, 100);
        arrProduct.push(obj);
        return arrProduct;
    },
