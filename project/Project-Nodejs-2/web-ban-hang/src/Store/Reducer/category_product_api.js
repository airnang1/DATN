...
export const getCategoryProductsAllApi = createAsyncThunk(
    ...
    async () => {
        const response = await axios.get(
            `http://13.228.168.148:3000/category_products`,
        );
...
export const deleteCategoryProductAllApi = createAsyncThunk(
    ...
    async (obj) => {
        await axios.delete(`http://13.228.168.148:3000/category_products/${obj.id}`);
        return obj;
    },
);
...
//         };
//         await axios.put(
//             `http://13.228.168.148:3000/category_products/${obj.id}`,
//             newCategoryProduct,
//         );
