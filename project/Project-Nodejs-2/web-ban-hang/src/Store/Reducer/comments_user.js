...
export const getCommentsUserApi = createAsyncThunk(
    ...
    async (productId) => {
        const response = await axios.get(
            `http://13.228.168.148:3000/comments_user?id_product=${productId}`,
        );
...
export const getCommentsAllApi = createAsyncThunk(
    ...
    async () => {
        const response = await axios.get(`http://13.228.168.148:3000/comments_user`);
        return response.data;
    },
);
...
export const updateCmtItem = createAsyncThunk(
    ...
    async (obj) => {
        ...
        await axios.put(
            `http://13.228.168.148:3000/comments_user/${obj.id}`,
            newCommentsUser,
        );
