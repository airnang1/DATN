...
export const getLaptopsApi = createAsyncThunk(
    ...
    async () => {
        const response = await axios.get(`http://13.228.168.148:3000/laptop_api`);
...
export const handleInsertProductToLaptop = createAsyncThunk(
    ...
    async (obj) => {
        ...
        await axios.post('http://13.228.168.148:3000/laptop_api', newProduct);
        return newProduct;
    },
);
...
export const handleRemoveLaptopItemApi = createAsyncThunk(
    ...
    async (obj) => {
        await axios.delete(`http://13.228.168.148:3000/laptop_api/${obj.id}`);
        return obj;
    },
);
...
export const handleUpdateLaptopItemApi = createAsyncThunk(
    ...
    async (obj) => {
        ...
        await axios.put(
            `http://13.228.168.148:3000/laptop_api/${obj.id}`,
            newLaptops,
        );
        return newLaptops;
    },
