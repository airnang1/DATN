...
export const getTabletsApi = createAsyncThunk(
    ...
    async () => {
        const response = await axios.get(`http://13.228.168.148:3000/tablet_api`);
...
export const handleInsertProductToTablet = createAsyncThunk(
    ...
    async (obj) => {
        ...
        await axios.post('http://13.228.168.148:3000/tablet_api', newProduct);
        return newProduct;
    },
);
...
export const handleRemoveTabletItemApi = createAsyncThunk(
    ...
    async (obj) => {
        await axios.delete(`http://13.228.168.148:3000/tablet_api/${obj.id}`);
        return obj;
    },
);
...
export const handleUpdateTabletItemApi = createAsyncThunk(
    ...
    async (obj) => {
        ...
        await axios.put(
            `http://13.228.168.148:3000/tablet_api/${obj.id}`,
            newTablets,
        );
        return newTablets;
    },
